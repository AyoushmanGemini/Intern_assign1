node {
    ...
    stage("build") {
        ...
        sh 'docker build -t http://localhost:8081/repository/dockerhosted-repo./:${BUILD_NUMBER} .'
        ...
        withCredentials([usernamePassword(credentialsId: 'nexus', passwordVariable: 'PSW', usernameVariable: 'USER')]) {
            ...
            sh 'docker push http://localhost:8081/repository/dockerhosted-repo./:${BUILD_NUMBER}'
        }
    }
}
